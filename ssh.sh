...
<font>┊┊┊┊ <b><font color="#ff5079">&nbsp;MΛFiΛ</font>™</b></font><br>
<font>┊┊┊✧ </font><br>
...
<font>    ✹   . <font color="#008080">&nbsp;FUCK NETWORK FEES</font></font><br>
<font>✦  · </font><br>
<b>&nbsp;Powered by <font color="#ff5079">MΛFiΛ™</font></b><br>
<font>     .  +  · </font>
EOF
...
acl url4 dstdomain -i /MAFIASSSH?
...
{
mkdir /etc/MAFIA-ssh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/ChangeUser.sh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/ChangePorts.sh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/UserManager.sh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/Banner.sh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/DelUser.sh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/ListUsers.sh
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/etc/RemoveScript.sh
wget -O speedtest-cli https://raw.githubusercontent.com/sivel/speedtest-cli/master/speedtest.py
wget https://raw.githubusercontent.com/MAFiA-6iXTY9iNE/MAFIA-ssh/main/menu
mv ChangeUser.sh /etc/MAFIA-ssh/ChangeUser.sh
mv ChangePorts.sh /etc/MAFIA-ssh/ChangePorts.sh
mv UserManager.sh /etc/MAFIA-ssh/UserManager.sh
mv Banner.sh /etc/MAFIA-ssh/Banner.sh
mv DelUser.sh /etc/MAFIA-ssh/DelUser.sh
mv ListUsers.sh /etc/MAFIA-ssh/ListUsers.sh
mv RemoveScript.sh /etc/MAFIA-ssh/RemoveScript.sh
mv speedtest-cli /etc/MAFIA-ssh/speedtest-cli
mv menu /usr/local/bin/menu
chmod +x /etc/MAFIA-ssh/ChangeUser.sh
chmod +x /etc/MAFIA-ssh/ChangePorts.sh
chmod +x /etc/MAFIA-ssh/UserManager.sh
chmod +x /etc/MAFIA-ssh/Banner.sh
chmod +x /etc/MAFIA-ssh/DelUser.sh
chmod +x /etc/MAFIA-ssh/ListUsers.sh
chmod +x /etc/MAFIA-ssh/RemoveScript.sh
chmod +x /etc/MAFIA-ssh/speedtest-cli
